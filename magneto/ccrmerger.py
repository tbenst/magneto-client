...
try:
    from aenea import RuleRef, Alternative, Repetition, Grammar, CompoundRule
except:
    print('error importing in ccrmerger')
...
class CCRMerger(object):
    ...
    #         utilities.save_json_file(self._config, settings.MAGNETO["paths"]["CCR_CONFIG_PATH"])
    def save_config(self):
        settings.save('enabled', self._config)
    def load_config(self):
        self._config = settings.load('enabled')
        # need to update _config
    # def load_config(self):
    #     if self.use_real_config:
    #         self._config = utilities.load_json_file(settings.MAGNETO["paths"]["CCR_CONFIG_PATH"])
    #     else:
    #         self._config  = {}
    ...
    def add_global_rule(self, rule):
        ...
        print("Adding global role " + rule.get_name())
    ...
    def add_app_rule(self, rule, context=None):
        ...
        print("Adding app rule " + rule.get_name())
    ...
    def add_selfmodrule(self, rule):
        ...
        print("Adding selfmod rule " + rule.get_name())
